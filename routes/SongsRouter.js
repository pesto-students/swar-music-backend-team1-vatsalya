...
import { createSong, getSongById, getAllSongs, deleteSong, retrieveURL, getAllSongByName, postAllSongsByPlaylist, countAllSongs} from "../controller/SongsController.js";
...
//COUNT ALL SONGS
songsrouter.get("/count/all",countAllSongs);
